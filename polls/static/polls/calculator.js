...
var cal = {
	...
	show_status: function(){
		return "current_value: " + this.current_value + "    op1: " + this.op1 + "    operator: " + this.operator + "    op2: " + this.op2 + "    result: " + this.result;
	},
	...
	enter_operator_chn: function(key){
		// 1, 2两种情况
		if (this.op1 == null && this.operator == null && this.op2 == null && this.result == null) {
			if (this.current_value == "") { 
				this.current_value = "0";
			}
			...
			this.operator = key;
			this.current_value = "";	// reset current_value
		...
		if (this.op1 != null && this.operator != null && this.op2 == null && this.result == null) {
			if (this.current_value == "") {
				...
				if (["sqrt", "square", "reciprocal", "ln", "sin", "cos", "tan", "asin", "acos", "atan", "sinh", "cosh", "tanh", "asinh", "acosh", "atanh", "ex", "factorial"].indexOf(key) != -1) {
					this.op1 = this.current_value;
					this.operator = key;
					this.current_value = "";
				} else {
					if (["+", "-", "*", "/", "pow", "permutation", "combination"].indexOf(key) != -1){
	...
	// Chn中计算部分的运算
	calculate: function(){
		if (["sqrt", "square", "reciprocal", "ln", "sin", "cos", "tan", "asin", "acos", "atan", "sinh", "cosh", "tanh", "asinh", "acosh", "atanh", "ex", "factorial"].indexOf(this.operator) != -1 && this.op1 != null) {
			this.result = this.cal_op();
			document.getElementById('screen').innerHTML = this.result;	// display
			this.op1 = null;
			this.operator = null;
			this.op2 = null;
		} else if (["+", "-", "*", "/", "pow", "permutation", "combination"].indexOf(this.operator) != -1 && this.op1 != null && this.op2 != null) {
			this.result = this.cal_op();
			document.getElementById('screen').innerHTML = this.result;	// display
			this.op1 = null;
			this.operator = null;
	...
	cal_op: function(){
		if (this.operator == "+") {
			...
			return String(Math.sqrt(parseFloat(this.op1)));
		} else if (this.operator == "square") {
			return String(Math.pow(parseFloat(this.op1), 2));
		} else if (this.operator == "reciprocal") {
			return String(1/parseFloat(this.op1));
		} else if (this.operator == "ln") {
			return String(Math.log(parseFloat(this.op1)));
		} else if (this.operator == "pow") {
			return String(Math.pow(parseFloat(this.op1), parseFloat(this.op2)));
		} else if (this.operator == "sin") {
			return String(Math.sin(parseFloat(this.op1)));
		} else if (this.operator == "cos") {
			return String(Math.cos(parseFloat(this.op1)));
		} else if (this.operator == "tan") {
			return String(Math.tan(parseFloat(this.op1)));
		} else if (this.operator == "asin") {
			return String(Math.asin(parseFloat(this.op1)));
		} else if (this.operator == "acos") {
			return String(Math.acos(parseFloat(this.op1)));
		} else if (this.operator == "atan") {
			return String(Math.atan(parseFloat(this.op1)));
		} else if (this.operator == "sinh") {
			return String(Math.sinh(parseFloat(this.op1)));
		} else if (this.operator == "cosh") {
			return String(Math.cosh(parseFloat(this.op1)));
		} else if (this.operator == "tanh") {
			return String(Math.tanh(parseFloat(this.op1)));
		} else if (this.operator == "asinh") {
			return String(Math.asinh(parseFloat(this.op1)));
		} else if (this.operator == "acosh") {
			return String(Math.acosh(parseFloat(this.op1)));
		} else if (this.operator == "atanh") {
			return String(Math.atanh(parseFloat(this.op1)));
		} else if (this.operator == "ex") {
			return String(Math.exp(parseFloat(this.op1)));
		} else if (this.operator == "factorial") {
			return String(this.factorial(parseFloat(this.op1)));
		} else if (this.operator == "permutation") {
			return String(this.permutation(parseFloat(this.op1), parseFloat(this.op2)));
		} else if (this.operator == "combination") {
			return String(this.combination(parseFloat(this.op1), parseFloat(this.op1)));
		}
	},
